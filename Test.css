...
:root {
    ...
    --app-background: url('https://i.ytimg.com/vi/TE2FwNJBZQw/maxresdefault.jpg'); /*App background*/
    ...
    --popout-bg: url('https://i.imgur.com/wQLLZBE.png'); /*Background for some elements*/
